...
function MessageLoadingPlaceholder() {
  const rows = [
    { id: "direct-loading-1", side: "theirs", size: "medium", lines: 2 },
    { id: "direct-loading-2", side: "mine", size: "short", lines: 1 },
    { id: "direct-loading-3", side: "theirs", size: "wide", lines: 3 },
    { id: "direct-loading-4", side: "mine", size: "medium", lines: 2 },
    { id: "direct-loading-5", side: "theirs", size: "short", lines: 1 },
  ];
      ...
      try {
        ...
        if (mode === "edit") {
          if (message.is_encrypted) {
            ...
            response = await editMessengerMessage(message.id, { text: nextText });
          }
        } else {
